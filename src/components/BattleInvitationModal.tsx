    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
        <motion.div 
          ...
          className="relative w-full max-w-md bg-[#161414] border-2 border-[#D9A9FF] rounded-3xl p-6 text-center shadow-[0_0_50px_rgba(217, 169, 255,0.3)] overflow-hidden"
        >
          {/* Animated pulse background element */}
          <div className="absolute -top-10 -left-10 w-40 h-40 bg-[#D9A9FF]/10 rounded-full blur-2xl animate-pulse pointer-events-none" />
          <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-[#C23E9E]/20 rounded-full blur-2xl animate-pulse pointer-events-none" />

          {/* Header Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#D9A9FF]/20 border border-[#D9A9FF]/40 rounded-full text-[#D9A9FF] text-[10px] font-black uppercase tracking-widest mb-4">
            <Radio className="w-3.5 h-3.5 animate-ping text-[#D9A9FF]" />
          ...
          <div className="my-4 flex flex-col items-center">
            <div className="relative mb-3">
              <img 
                ...
                className="w-20 h-20 rounded-full object-cover border-4 border-[#D9A9FF] shadow-xl" 
              />
              <div className="absolute -bottom-2 -right-2 p-2 bg-[#C23E9E] border-2 border-black rounded-full text-white">
            ...
            <p className="text-xs text-slate-300 mt-1 max-w-xs">
              Te ha invitado a una sala de <span className="text-[#D9A9FF] font-bold">Waacking Live Battle</span>
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mt-6">
            ...
            <button
              ...
              className="py-3 px-4 bg-[#D9A9FF] hover:bg-[#BA7EFF] text-black font-black text-xs rounded-xl uppercase transition-all shadow-lg hover:shadow-[#D9A9FF]/30 flex items-center justify-center gap-2"
            >
